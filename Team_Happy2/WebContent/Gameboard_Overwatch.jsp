...
%>
	...
	<div
		...
		<div
			...
			<div class="fw-bolder"
				...
				background-image: url('img/Lostark.png'); background-size: cover; cursor: pointer;"
				onclick="location.href='board?game_num=10';">Lostark</div>
			<div class="fw-bolder"
				style="border: 1px solid black; width: 200px; height: 200px; line-height: 200px; 
	...
	<div style="position: absolute; right: 100px; bottom: 150px;">
		<button class="btn btn-lg btn-primary btn-block text-uppercase"
			onclick="location.href='NewWrite_Overwatch.jsp'">글쓰기</button>
	</div>
